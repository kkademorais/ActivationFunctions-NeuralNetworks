...
def relu(neuronValue: float) -> float:
    # if neuronValue > 0: return neuronValue
    return max(neuronValue,0)
...
def neuralNetwork():
    ...
    print(f"Calculando utilizando Rectified Linear Unit (ReLU): {relu(neuronValue)}")
